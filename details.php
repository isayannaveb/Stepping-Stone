...
<div id="container">
	<div class="nav">
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<br />
						<input type="checkbox" required> I Agree the <a href="#terms" data-toggle="modal"> Terms and Condition</a> of Stepping Stone Inc.
					</center>
				</div>
			<div class="modal-footer">
				<center>
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">Stepping Stone Inc. Terms and Condition</h3>
			</div>
				<div class="modal-body">
					<ul>
	...
	<div id="footer">
		<div class="foot">
			...
			<div id="develop">
				<h4>Developed By:</h4>
					<ul>
						<a href="#"><li>John Cyrrus Quirino</li><a>
						<a href="#"><li>Anna Veb Humaynon</li><a>
						<a href="#"><li>John Benedict Quirino</li><a>
